clear;clc;
filePath = "C:\Users\Semanti Basu\Documents\OneDrive_2020-02-19\3D Ceaser dataset\Image and point generation\Image and point generation\ceasar_mat_test\";
...
writetable(T,'frontalpoints_test.csv','WriteVariableNames',false);
%%
matData={};
for k = 51:100
% for k=1:3
...
writetable(T2,'sideviewpoints_test.csv','WriteVariableNames',false);